...
window.PORTFOLIO = {
  ...
  machines: {
    ...
    tip: "Click any milestone to learn more • Scroll to explore the full timeline",
    items: [
  ...
  contact: {
    ...
    socials: [
      ...
      { label: "arXiv", href: "https://arxiv.org/abs/2511.20138", icon: `<svg width="16" height="16" viewBox="0 0 16 16" fill="currentColor"><path d="M2 2h12v12H2V2zm1 1v10h10V3H3zm1 1h8v1H4V4zm0 2h8v1H4V6zm0 2h6v1H4V8zm0 2h8v1H4v-1z"/></svg>` },
